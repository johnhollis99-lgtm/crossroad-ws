...
- **Decision:** [r]
- **Note:** _(curator fills in if needed)_
<!-- IMPORT: [r] curated=false boost=0 -->
...
<!-- IMPORT: [x] curated=true boost=0 note="_(curator typo-resolved: was [+ → [x] pe" -->
...
<!-- IMPORT: [x] curated=true boost=0 note="_(NV-bleed downgrade cycle-2: was [+], n" -->
...
<!-- IMPORT: [+] curated=true boost=20 note="_(curator typo-resolved: was [+ → [+] pe" -->
...
- [+] Mount Whitney — soul-doctrine flagship, highest peak in the contiguous US, granite batholith story
  <!-- IMPORT: match_boosted: matched "Mount Whitney" (geology, id=6dbb1b74…) boost=20 via exact_name+tiebreaker_editorial -->
- [+] Mono Lake — alkaline lake, tufa towers, Paiute anthropology layer, Sierra rain-shadow ecology
  <!-- IMPORT: match_boosted: matched "Mono Lake" (geology, id=f032f930…) boost=20 via exact_name -->
- [+] Long Valley Caldera — supervolcano, geothermal activity, geologic-time-scale story
  <!-- IMPORT: match_boosted: matched "Long Valley Caldera" (geology, id=d68fe5cb…) boost=20 via exact_name -->
- [+] Anza-Borrego Desert State Park — desert geology, paleontology, Cahuilla anthropology
  <!-- IMPORT: match_boosted: matched "Anza-Borrego Desert State Park" (nature, id=cadaa1bc…) boost=20 via exact_name -->
- [+] Mount Shasta — stratovolcano, sacred mountain, Modoc/Wintu anthropology
  <!-- IMPORT: match_boosted: matched "Mount Shasta" (nature, id=8b1404a9…) boost=20 via exact_name -->
- [+] Lassen Peak — most recent CA eruption (1914-1917), volcanic landscape
  <!-- IMPORT: match_boosted: matched "Lassen Peak" (nature, id=6bd2c415…) boost=20 via exact_name -->
- [+] Devils Postpile National Monument — columnar basalt, glacial geology
  <!-- IMPORT: match_boosted: matched "Devils Postpile National Monument" (geology, id=8c70d0c6…) boost=20 via exact_name -->
- [+] Trona Pinnacles — tufa spires, Searles Lake paleoclimate (lat=35.6172, lon=-117.3658, cat=geology)
  <!-- IMPORT: seed_inserted: inserted new editorial seed id=d60a258d… score=75 boost=20 -->
- [+] Pinnacles National Park — Neenach Volcano transported by San Andreas Fault
  <!-- IMPORT: match_boosted: matched "Pinnacles National Park" (nature, id=58d804d7…) boost=20 via exact_name -->
- [+] Yosemite Falls — Sierra granite, glacial sculpting
  <!-- IMPORT: match_boosted: matched "Yosemite Falls" (nature, id=ff18034a…) boost=20 via exact_name -->
- [+] Ancient Bristlecone Pine Forest — oldest individual trees on Earth, White Mountains
  <!-- IMPORT: match_boosted: matched "Ancient Bristlecone Pine Forest" (nature, id=4c9bf56f…) boost=20 via exact_name -->
- [+] Painted Dunes (Lassen) — volcanic ash + lichen, photographic landscape (lat=40.5708, lon=-121.4244, cat=geology)
  <!-- IMPORT: seed_inserted: inserted new editorial seed id=c647c0b9… score=75 boost=20 -->
- [+] Bumpass Hell — hydrothermal area in Lassen, geothermal soul-doctrine (lat=40.4575, lon=-121.4017, cat=geology)
  <!-- IMPORT: seed_inserted: inserted new editorial seed id=a824aaed… score=75 boost=20 -->
- [+] San Andreas Fault (Carrizo Plain segment) — most visible fault expression in CA (lat=35.1167, lon=-119.7833, cat=geology)
  <!-- IMPORT: seed_inserted: inserted new editorial seed id=06972144… score=75 boost=20 -->
- [+] Death Valley — lowest point in North America, Pleistocene lake, badwater geology
  <!-- IMPORT: match_boosted: matched "Death Valley" (hidden_gems, id=5ff63b85…) boost=20 via exact_name -->
